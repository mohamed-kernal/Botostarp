...
<div class="container theme-showcase" role="main">
 ...
 <div class="page-header">
      ...
      <p>
        ...
        <button type="button" class="btn btn-lg btn-primary">Docker</button>
        <button type="button" class="btn btn-lg btn-success">Veem</button>
        <button type="button" class="btn btn-lg btn-info">Info</button>
        <button type="button" class="btn btn-lg btn-warning">Git</button>
        <button type="button" class="btn btn-lg btn-danger">shef</button>
        <button type="button" class="btn btn-lg btn-link">GetStared</button>
      </p>
